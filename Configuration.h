...
#define STRING_CONFIG_H_AUTHOR "(Rocco, Ender 3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3V3R2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 152.0
  #define DEFAULT_bedKi 29.71
  #define DEFAULT_bedKd 518.2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.63 }
...
#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping, DEFAULT= 20
...
// Service position (NOT FOUND IN MARLIN 2.1.2 OR 2.X BUGFIX)
#define X_SERVICE_POS 115
#define Y_SERVICE_POS 115

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -5 // Older revision uses 0 offset
#define Z_MIN_POS 0
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z // Allow movement beyond the z-stop for probe-based mesh leveling, DEFAULT OFF
